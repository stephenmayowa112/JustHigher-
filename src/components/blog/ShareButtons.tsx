...
export default function ShareButtons({ title, url, description }: ShareButtonsProps) {
  ...
  const captivatingIntros = [
    'Read this powerful write-up to stay inspired',
    'This will elevate your thinking',
    'Ideas that push you higher',
  ...
  // For WhatsApp, include the URL in the message
  const whatsappText = `${shareIntro}: "${title}" - ${shareUrl}`;
